...
export const Index = () => (
  ...
  <Col xs={12} md={6}>
    <RaisedButton className="dashboard-btn" label='View All Flights Today - Admin' primary={true} icon={Icon.MUI('date_range')}
      onTouchTap={goTo('flights')}/>
  </Col>
  <p> </p>
  <Col xs={12} md={6}>
    <RaisedButton className="dashboard-btn" label='View Assigned Flight' primary={true} icon={Icon.MUI('flight_takeoff')}
      onTouchTap={goTo('flight/'+1)}/>
